...
export default function IdUpload() {
  ...
  const addPost = async (prevState, formData) => {
    ...
    const uploadImg = await UploadImage(selfie, "blgImage");
            ...
            <div className="mx-5 my-6 flex flex-col items-center gap-5">
              ...
              <div className="flex flex-col justify-center items-center">
                ...
                <p className="text-base w-[600px] mt-3">
                  ...
                  cooperation. Our team will carefully review the details
                  provided and confirm your submission within the next 48 hours.
                  If any further information is required, we will reach out to
                  you promptly.
                </p>
              </div>
